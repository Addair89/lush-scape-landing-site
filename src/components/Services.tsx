...
const Services = () => {
  ...
  return <section id="services" className="relative py-20 overflow-hidden">
      {/* Parallax Background */}
      <div className="absolute inset-0 bg-cover bg-center bg-fixed opacity-20" style={{
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {services.map((service, index) => <div key={index} className="bg-card rounded-lg p-8 shadow-soft hover:shadow-nature transition-all duration-300 hover:scale-105">
